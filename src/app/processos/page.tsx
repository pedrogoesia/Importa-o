...
import { Plus, Ship, AlertCircle, LayoutGrid, List, Building2, ArrowRight } from "lucide-react";
...
export default function ProcessosPage() {
  ...
  // Agrupa processos por empresa (cada cliente = uma empresa/CNPJ próprio)
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Cada cliente tem sua própria empresa/CNPJ · agrupe os processos por cliente"
        action={
          <button
        ...
        <div className="mb-5 hidden shrink-0 rounded-lg border border-slate-200 bg-white p-0.5 sm:flex">
          <button
            ...
            className={cn(
              ...
              view === "cliente" ? "bg-slate-100 text-slate-700" : "text-slate-400"
            )}
          >
